...
4. **Specialists** execute scope directly under a sticky `Session role: DELEGATED_SUBAGENT` assignment and do not access `wiki/` unless wiki work is explicitly in scope.
